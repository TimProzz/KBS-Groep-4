<div class="container product push-padding">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 productInfo">
            ...
            <input type="number" name="hoeveel" min="0" placeholder="<?php echo getCartTotal($row["StockItemID"]); ?>" value="<?php echo $row["StockItemID"]; ?>" class="numberWinkelmand numberWinkelmand<?php echo $row["StockItemID"]; ?>">

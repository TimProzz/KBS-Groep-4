<div class="container push-padding" style="width: 520px; padding: 50px 20px;">
    ...
    <form action="register.php" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" name="last name" class="form-control" id="last name" placeholder="Achternaam" value="<?php if(isset($last_name)){echo $last_name;}?>" required>
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" name="postal code" class="form-control" id="postal code" placeholder="Postcode" value="<?php if(isset($postal_code)){echo $postal_code;}?>"required>
          </div>
        </div>
        <div class="form-group">
          <label for="phonenumber">Telefoonnummer</label>
          <input type="text" name="phonenumber" class="form-control" id="postal code" placeholder="Telefoonnummer" value="<?php if(isset($phonenumber)){echo $phonenumber;}?>">
        </div><br><br>
        <div class="form-group">
        ...
        <button type="submit" value="Submit" name="Registreer" class="btn btn-primary">Registreren</button>
    </form>
    <?php

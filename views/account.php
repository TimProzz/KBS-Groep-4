        ...
        while($row = $accountDetails->fetch()) {
            ?>
                <form action="/account.php" method="post">
                    Naam:<br><input type="text" name="naam" placeholder="Naam" value="<?php if(!empty($row['naam'])) { echo $row['naam']; } ?>"><br>
                    Adres:<br><input type="text" name="adres" placeholder="Adres" value="<?php if(!empty($row['adres'])) { echo $row['adres']; } ?>"><br>
                    Woonplaats:<br><input type="text" name="woonplaats" placeholder="Woonplaats" value="<?php if(!empty($row['woonplaats'])) { echo $row['woonplaats']; } ?>"><br>
